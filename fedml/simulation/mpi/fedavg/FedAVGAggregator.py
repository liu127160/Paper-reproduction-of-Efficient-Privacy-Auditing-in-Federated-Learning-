    ...
    def test_on_server_for_all_clients(self, round_idx):
        ...
        if round_idx % self.args.frequency_of_the_test == 0 or round_idx == self.args.comm_round - 1:
            ...
            if round_idx == self.args.comm_round - 1:
                ...
                metric_result_in_current_round = self.aggregator.test(self.val_global, self.device, self.args, is_test=True)
                train_metric_result_in_current_round = self.aggregator.test(self.train_global, self.device, self.args, is_test=False)
